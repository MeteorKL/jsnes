...
JSNES.PPU = function (nes) {
    ...
    // Rendering Options:
    this.showSpr0Hit = true;
    this.clipToTvSize = true;

    // 设置调色板 PaletteTable，有颜色加重 emphasis
    ...
    for (var emph = 0; emph < 8; emph++) {
        ...
        for (i = 0; i < 64; i++) {
            rgb = curTable[i];
            r = Math.floor(((rgb >> 16) & 0xFF) * rFactor);
            g = Math.floor(((rgb >> 8) & 0xFF) * gFactor);
            b = Math.floor((rgb & 0xFF) * bFactor);
...
JSNES.PPU.prototype = {
    ...
    reset: function () {
        ...
        this.regHT = 0;
        this.regFH = 0;
        this.regS = 0; // equals to this.f_bgPatternTable
